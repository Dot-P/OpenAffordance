...
def precompute_text_related_properties(labelset_name):
    ...
    print('Labelset name: {}'.format(labelset_name))
    ...
    elif 'openscan' in labelset_name:
        labelset = list(OPENSCAN_AFFORDANCE_LABELS_105)
        palette = get_palette(colormap='openscan_105', num_cls=105)
