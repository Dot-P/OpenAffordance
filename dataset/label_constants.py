...
OPENSCAN_AFFORDANCE_LABELS_105 = (
    'carry things',
    'holding up a roof',
    'rest',
    'sit',
    ...
    'store file',
    'make a captured voice become audible',
    'type',
    'eat dinner',
    'bake cookies',
    'furnish',
